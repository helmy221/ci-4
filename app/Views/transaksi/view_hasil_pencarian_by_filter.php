...
<div x-data="TransaksiFilterUI()" x-show="!loaded">
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden dark:border-gray-800 dark:bg-white/[0.03]">
                                        ...
                                        <?php foreach ($hasil as $t): ?>
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 text-right">
                                                    <!--<a href="<?= base_url('transaksi/view_detail_paket/' . $t['id_transaksi_pemenang']) ?>" class="text-blue-600 hover:text-blue-900 font-medium">Details</a>-->
                                                    <button @click='openEditModalFilter(<?= json_encode($t, JSON_HEX_APOS | JSON_HEX_QUOT) ?>)'
        ...
        <?= $this->include('transaksi/view_hasil_pencarian_by_filter_detail') ?>
        <?= $this->endSection() ?>
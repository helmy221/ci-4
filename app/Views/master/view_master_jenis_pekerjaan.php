                        ...
                        <table class="min-w-full">
                            ...
                            <thead>
                                <tr class="border-b border-gray-100 dark:border-gray-800">
                                    ...
                                    <th class="px-5 py-3 sm:px-6">
                                        <div class="flex items-center">
                                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400"> Nama Jenis Pengadaan </p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 sm:px-6">
                                        <div class="flex items-center">
                                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400"> Kode Pengadaan </p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 sm:px-6">
                                        <div class="flex items-center">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                <?php if (!empty($jenis_pekerjaan) && is_array($jenis_pekerjaan)) : ?>
                                    <?php foreach ($jenis_pekerjaan as $jenis) : ?>
                                        <tr>
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400"> <?= $jenis['id_master_jenis_pengadaan'] ?> </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?= $jenis['nama_master_jenis_pengadaan'] ?> </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="rounded-full bg-success-50 px-2 py-0.5 text-theme-xs font-medium text-success-700 dark:bg-success-500/15 dark:text-success-500"> <?= $jenis['singkatan_master_jenis_pengadaan'] ?> </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">

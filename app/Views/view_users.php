            ...
            <table id="usersTable" x-data-show="!loading" class="min-w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-10 dark:dark:bg-white/[0.03]">
                    <template x-for="user in users" :key="user.id">
                        <tr class="hover:bg-gray-50 border-gray-100 dark:border-gray-800">
                            <td class="px-4 py-2 border-b dark:text-gray-400 border-gray-100" x-text="user.id"></td>
                            <td class="px-4 py-2 border-b dark:text-gray-400  border-gray-100" x-text="user.name"></td>
                            <td class="px-4 py-2 border-b dark:text-gray-400 border-gray-100" x-text="user.email"></td>

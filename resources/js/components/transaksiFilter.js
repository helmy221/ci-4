window.TransaksiFilterUI = function() {
    return {
        users: [],
        roles: [],
        units: [],
        ...
        async openEditModalFilter(data) {
            ...
            this.showEditModalFilter = true;
            // console.log('Open Modal Edit:', this.editForm);
        },

        async closeEditModal() {
            this.showEditModalFilter = false;
            this.editForm = {};
            this.selectedRoles = [];
            this.selectedUnit = '';
